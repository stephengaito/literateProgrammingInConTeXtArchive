...
\def\startLunaTestSuite{\relax}
\def\stopLunaTestSuite{\relax}
\def\startLunaTestCase{\relax}
\def\stopLunaTestCase{\relax}
\definetyping[LunaTests]
\setuptyping[LunaTests][option=lua]
