...
assert.isEqual(macroBody[30], "\\unexpanded\\def\\clearTest#1{")
assert.isEqual(macroBody[31], "  \\directlua{")
assert.isEqual(macroBody[32], "    thirddata.literateProgs.clearCodeStream(")
...
assert.isEqual(macroBody[38], "\\unexpanded\\def\\setTestStream#1{")
assert.isEqual(macroBody[39], "  \\directlua{")
assert.isEqual(macroBody[40], "    thirddata.literateProgs.setCodeStream(")
...
assert.isEqual(macroBody[46], "\\unexpanded\\def\\prependTest#1{")
assert.isEqual(macroBody[47], "  \\directlua{")
assert.isEqual(macroBody[48], "    thirddata.literateProgs.setPrepend(")
assert.isEqual(macroBody[49], "      'Test',")
assert.isEqual(macroBody[50], "      '#1',")
assert.isEqual(macroBody[51], "      true")
assert.isEqual(macroBody[52], "    )")
assert.isEqual(macroBody[53], "  }")
assert.isEqual(macroBody[54], "}")
assert.isEqual(macroBody[55], "\\unexpanded\\def\\appendTest#1{")
...
assert.isEqual(macroBody[60], "      false")
