...
assert.isEqual(macroBody[7],  "    \\directlua{")
assert.isEqual(macroBody[8],  "      thirddata.literateProgs.setCodeStream(")
assert.isEqual(macroBody[9],  "        'Test',")
assert.isEqual(macroBody[10], "        '#1'")
assert.isEqual(macroBody[11], "      )")
assert.isEqual(macroBody[12], "    }%")
assert.isEqual(macroBody[13], "  \\else")
assert.isEqual(macroBody[14], "    \\directlua{")
assert.isEqual(macroBody[15], "      thirddata.literateProgs.setCodeStream(")
assert.isEqual(macroBody[16], "        'Test',")
assert.isEqual(macroBody[17], "        'default'")
assert.isEqual(macroBody[18], "      )")
assert.isEqual(macroBody[19], "    }%")
assert.isEqual(macroBody[20], "  \\fi%")
assert.isEqual(macroBody[21], "  \\oldStartTest%")
assert.isEqual(macroBody[22], "}")
assert.isEqual(macroBody[23], "\\let\\oldStopTest=\\stopTest")
assert.isEqual(macroBody[24], "\\unexpanded\\def\\stopTest{%")
assert.isEqual(macroBody[25], "  \\oldStopTest%")
assert.isEqual(macroBody[26], "  \\directlua{")
assert.isEqual(macroBody[27], "    thirddata.literateProgs.addCode(")
assert.isEqual(macroBody[28], "      'Test',")
assert.isEqual(macroBody[29], "      '_typing_'")
assert.isEqual(macroBody[30], "    )")
assert.isEqual(macroBody[31], "  }")
assert.isEqual(macroBody[32], "}")
assert.isEqual(macroBody[33], "\\unexpanded\\def\\createTestFile#1#2#3{%")
assert.isEqual(macroBody[34], "  \\directlua{")
assert.isEqual(macroBody[35], "    thirddata.literateProgs.createCodeFile(")
assert.isEqual(macroBody[36], "      'Test',")
assert.isEqual(macroBody[37], "      '#1',")
assert.isEqual(macroBody[38], "      '#2',")
assert.isEqual(macroBody[39], "      '#3'")
assert.isEqual(macroBody[40], "    )")
assert.isEqual(macroBody[41], "  }")
assert.isEqual(macroBody[42], "}")
\stopLuaTest
\stopTestCase
